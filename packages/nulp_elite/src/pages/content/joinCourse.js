...
const JoinCourse = () => {
  ...
  useEffect(() => {
    ...
    //         filters: {
    //           status: "1",
    //           courseId: "do_1140307973902336001967",
    //           enrollmentType: "open",
    //         },
    //         sort_by: {
    //           createdDate: "desc",
      ...
      <Grid container spacing={2}>
        ...
        >
          ...
          >
            ...
            >
              {t("BATCH_START_DATE")}:{" "}
              {userData?.result?.content?.batches?.[0]?.startDate}
            </Typography>
            <Typography
              variant="h7"
              style={{
            ...
            >
              {t("BATCH_END_DATE")}:{" "}
              {userData?.result?.content?.batches?.[0]?.endDate}
            </Typography>
            <Typography
              variant="h7"
              style={{
            ...
            >
              ...
              {userData?.result?.content?.batches?.[0]?.enrollmentEndDate}
            </Typography>
          </Box>
        </Box>
            ...
            {userData?.result?.content?.children.map((faqIndex) => (
              ...
              >
                ...
                {faqIndex.children.map((faqIndexname) => (
                  <AccordionDetails style={{paddingLeft:'35px',display:'flex'}}>
                     <SummarizeOutlinedIcon/> 
                    <Link href="#" key={faqIndexname.id}>
                   {faqIndexname.name}
                    </Link>
                  </AccordionDetails>
                ))}
        ...
        >
          ...
          <AccordionDetails style={{ background: "#fff" }}>
            ...
            >
              {t("CREATED_ON")}:{" "}
              {userData?.result?.content?.children[0]?.createdOn}
            </Typography>
            <Typography
              variant="h7"
              style={{
