...
let devEnvVariables = {
  ...
  PORTAL_SESSION_SECRET_KEY:
    "sunbird,717b3357-b2b1-4e39-9090-1c712d1b8b64".split(","),
  ...
  CONFIG_URL:
    env.sunbird_config_service_url || "https://nulp.niua.org/api/config/",
  ...
  // discussion forum
  discussion_forum_token:
    env.discussion_forum_token || "a4838b88-6a04-4293-a504-245862cad404",
  ...
  PORTAL_AUTH_SERVER_URL:
    env.sunbird_portal_auth_server_url || "https://nulp.niua.org/auth",
  ...
  PORTAL_API_AUTH_TOKEN:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJkTEJ3cG5MdE1SVWRCOTVBdWFCWjhMd0hSR2lTUTBpVCJ9.Q7-3SuUgnZXJuu-j2_kw9r8J82ckSxRR6zxylpgVG5o",
  PORTAL_TELEMETRY_PACKET_SIZE: env.sunbird_telemetry_packet_size || 1000,
  PORTAL_ECHO_API_URL:
    env.sunbird_echo_api_url || "https://nulp.niua.org/api/echo/",
  ...
  DEVICE_REGISTER_API:
    ...
    "https://nulp.niua.org/v3/device/register/",
  DEVICE_PROFILE_API:
    process.env.sunbird_device_profile_api ||
    "https://nulp.niua.org/api/v3/device/profile/",
  ...
  learnathon_voting_table_user: "nulp",
  learnathon_voting_table_host: "localhost",
  learnathon_voting_table_database: "nulp",
  Learnathon_voting_table_password: "nulp",
  learnathon_voting_table_port: 5433,
  ...
  sunbird_azure_account_name:
    env.sunbird_azure_account_name || "sunbirddevprivate",
  sunbird_azure_account_key:
    env.sunbird_azure_account_key ||
    "nzng+3OKQQyuDkCVz+TqFVnLIjqCvZcL+Wiio9zXBG9nUXoJ4atnT+u8D7+/IDiqMy6eN72NXkHXgkgvLx6Qqw==",
  ...
  CONTENT_EDITORS_URL: {
    COLLECTION_EDITOR:
      env.sunbird_collectionEditorURL ||
      "/thirdparty/editors/collection-editor/index.html",
    CONTENT_EDITOR:
      env.sunbird_contentEditorURL ||
      "/thirdparty/editors/content-editor/index.html",
    GENERIC_EDITOR:
      env.sunbird_genericEditorURL ||
      "/thirdparty/editors/generic-editor/index.html",
  },
  PHRASE_APP: {
  ...
  sunbird_anonymous_device_register_api:
    ...
    "https://nulp.niua.org/api/api-manager/v2/consumer/portal_anonymous/credential/register",
  sunbird_loggedin_device_register_api:
    env.sunbird_loggedin_device_register_api ||
    "https://nulp.niua.org/api/api-manager/v2/consumer/portal_loggedin/credential/register",
  sunbird_kong_refresh_token_api:
    env.sunbird_kong_refresh_token_api ||
    "https://nulp.niua.org/auth/v1/refresh/token",
  ...
  sunbird_logged_default_token:
    env.sunbird_logged_default_token ||
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJkTEJ3cG5MdE1SVWRCOTVBdWFCWjhMd0hSR2lTUTBpVCJ9.Q7-3SuUgnZXJuu-j2_kw9r8J82ckSxRR6zxylpgVG5o",
};
devEnvVariables.PORTAL_CASSANDRA_URLS =
...
let preprodEnvVariables = {
  ...
  sunbird_portal_slugForProminentFilter:
    env.sunbird_portal_slugForProminentFilter || "igot",
  sunbird_device_api: env.sunbird_device_api || "https://nulp.niua.org/api/",
  ...
  discussions_middleware:
    env.discussions_middleware || "http://disussionsmw-service:3002/discussion",
  KEYCLOAK_GOOGLE_DESKTOP_CLIENT: {
    clientId: env.sunbird_google_desktop_keycloak_client_id,
    secret: env.sunbird_google_desktop_keycloak_secret,
  },
  ...
  PORTAL_PORT: env.sunbird_port || 3000,
  Sunbird_bot_configured: "true",
  Sunbird_bot_service_URL: "https://nulp.niua.org/chatapi/bot",
  ...
  PORTAL_PRIMARY_BUNDLE_LANGUAGE:
    env.sunbird_portal_primary_bundle_language || "en",
  CONTENT_SERVICE_UPSTREAM_URL:
    env.sunbird_content_service_upstream_url || "http://localhost:5000/",
  LEARNER_SERVICE_UPSTREAM_URL:
  ...
  CACHE_STORE: env.sunbird_cache_store || "memory",
  REPORT_SERVICE_URL:
    "https://nulp.niua.org/api/data/v1/report-service" ||
    env.sunbird_report_service_url ||
    "https://staging.open-sunbird.org/api/data/v1/report-service",
  CACHE_TTL: env.sunbird_cache_ttl || 1800,
  ...
  content_Service_Local_BaseUrl:
    env.sunbird_content_service_local_base_url ||
    "http://content_service_content_service:5000",
  ANDROID_APP_URL: env.sunbird_android_app_url || "http://www.sunbird.org",
...
preprodEnvVariables.PORTAL_CASSANDRA_URLS =
  env.sunbird_cassandra_urls && env.sunbird_cassandra_urls !== ""
    ? env.sunbird_cassandra_urls.split(",")
    : ["localhost"];
...
let newStagingEnvVariables = {
  ...
  ML_SERVICE_BASE_URL:
    env.ML_SERVICE_BASE_URL || "https://nulp.niua.org/staging",
  ML_URL: {
    OBSERVATION_URL: "",
  },
  KEYCLOAK_GOOGLE_DESKTOP_CLIENT: {
  ...
  PORTAL_PORT: env.sunbird_port || 3000,
  learner_Service_Local_BaseUrl: "http://11.2.6.6/",
  REPORT_SERVICE_URL: "https://nulp.niua.org/api/data/v1/report-service",
  // PORTAL_API_AUTH_TOKEN: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI1S0xKdzBHRUd0M2VEMmlKNjJ1M05tRG1QY3Z6b0trWSJ9.6Av5aPfb_m22sCbbXdUKW3dQc8cRAt3tiIcCyGHjCzg',
  ...
  BUILD_NUMBER:
    env.sunbird_build_number || packageObj.version + "." + packageObj.buildHash,
  TELEMETRY_SERVICE_LOCAL_URL:
    "https://nulp.niua.org" || "http://telemetry-service:9001/",
  PORTAL_API_CACHE_TTL: env.sunbird_api_response_cache_ttl || "600",
  TENANT_CDN_URL: env.sunbird_tenant_cdn_url || "",
  CLOUD_STORAGE_URLS: env.sunbird_cloud_storage_urls,
  PORTAL_CASSANDRA_CONSISTENCY_LEVEL:
  ...
  sunbird_azure_resourceBundle_container_name:
    env.sunbird_azure_resourceBundle_container_name || "label",
  sunbird_data_product_service:
    env.sunbird_data_product_service || "https://nulp.niua.org/",
  GOOGLE_OAUTH_CONFIG_IOS: {
    clientId: "" || env.sunbird_google_oauth_ios_clientId,
    clientSecret: "" || env.sunbird_google_oauth_ios_clientSecret,
  },
};
newStagingEnvVariables.PORTAL_CASSANDRA_URLS =
  env.sunbird_cassandra_urls && env.sunbird_cassandra_urls !== ""
    ? env.sunbird_cassandra_urls.split(",")
    : ["localhost"];
